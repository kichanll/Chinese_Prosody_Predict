...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = 'output'
    for i in range(1,5):
        path_dataset = os.path.join(OUTPUT_DIR, 'final_tag_{}_pos.txt'.format(i))
        ...
        save_dataset(train_dataset, os.path.join(OUTPUT_DIR, 'biaobei{}'.format(i), 'train'))
        save_dataset(val_dataset, os.path.join(OUTPUT_DIR, 'biaobei{}'.format(i), 'val'))
        save_dataset(test_dataset, os.path.join(OUTPUT_DIR, 'biaobei{}'.format(i), 'test'))
