...
if __name__ == '__main__':
    ...
    params.embedding_path = os.path.join(args.data_dir, 'embedding200.npy')
    ...
    for i in range(1, 5):
        # load data
        data_loader = DataLoader(os.path.join(args.data_dir, 'biaobei{}'.format(i)), params)
        data = data_loader.load_data(['train', 'val'], os.path.join(args.data_dir, 'biaobei{}'.format(i)))
        ...
        if os.path.exists(os.path.join(args.model_dir, 'biaobei{}'.format(i))):
            os.makedirs(os.path.join(args.model_dir, 'biaobei{}'.format(i)), exist_ok=True)
        train_and_evaluate(model, train_data, val_data, optimizer, loss_fn, metrics, params, os.path.join(args.model_dir, 'biaobei{}'.format(i)),
                           args.restore_file)
