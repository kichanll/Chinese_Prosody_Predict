...
parser.add_argument('--data_dir', default='output/biaobei1', help="Directory containing the dataset")
parser.add_argument('--model_dir', default='model/biaobei1', help="Directory containing .pth.tar model")
